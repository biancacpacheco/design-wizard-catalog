...
SCRIPT_MODULE = "catalog.usage_of_specific_elements.exclusive_use_of_infinite_loops_test"
...
class TestUsageOfPreEstablishedFunctions(unittest.TestCase):
    ...
    def test_valid_example(self):
        data_file = os.path.join("tests", "data", "binarysearch.py")
    ...
    def test_missing_elements(self):
        data_file = os.path.join("tests", "data", "insertionsort.py")
        stdout, stderr, returncode = self.run_script_with_file(data_file)
